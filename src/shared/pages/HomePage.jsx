  ...
  return (
    <>
      ...
      <div className="flex-col justify-center align-center place-items-center p-10">
        <h1 className="text-white mt-30 lg:mt-32 xl:mt-40 2xl:mt-50 mb-7 lg:mb-10 xl:mb-12 2xl:mb-30 text-lg sm:text-xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:xl:text-8xl">
          LUIS GERARDO AQUINO
        </h1>
