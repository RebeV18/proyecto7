  ...
  return (
    <>
      ...
      <div className="flex-col justify-center align-center place-items-center p-10">
        ...
        <p className="custom-card font-montserrat border-1 border-white rounded-lg text-white text-center item-center px-3 py-8 text-xs sm:text-base md:text-lg lg:text-2xl xl:text-xl sm:px-2 xl:px-10 xl:py-12 2xl:text-3xl 2xl:px-8 2xl:py-15 2xl:mb-30">
